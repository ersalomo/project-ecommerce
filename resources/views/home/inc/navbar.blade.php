<nav class="navbar navbar-expand-lg navbar-light bg-light ">
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('home-page') }}">All Products</a></li>
                        <li>
                            <hr class="dropdown-divider" />
                        </li>
                        <li><a class="dropdown-item" href="home-page#!">Popular Items</a></li>
                        <li><a class="dropdown-item" href="home-page#!">New Arrivals</a></li>
                    </ul>
                </li>
            </ul>
            @auth
                {{-- show all cards using this route --}}
                ...
                <div class="dropdown px-2">
                    <button class="btn btn-outline-dark text-name dropdown-toggle ml-3" type="button"
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item hidden-navbar-home btn" href="{{ route('user-profile') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            @else
                <a type="submit" href="{{ route('login') }}" class="btn btn-md btn-dark">Login <svg
    ...
    <script src="{{ asset('bootstrap/js/hidden-header.js') }}"></script>
